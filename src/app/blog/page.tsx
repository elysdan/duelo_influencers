...
export const metadata = { title: 'Novedades y Blog Oficial | Micasino TV Show' }
    ...
    <div className="flex flex-col min-h-screen bg-[#06070b]">
      ...
      <main className="flex-grow pt-24 pb-16 px-4">
        <div className="max-w-[95%] mx-auto flex flex-col gap-10">
          ...
          {/* Header Banner */}
          <div className="relative rounded-3xl overflow-hidden p-8 sm:p-12 border border-white/5 bg-[#0b0e14] shadow-2xl flex flex-col justify-center text-center gap-4">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(245,197,24,0.04)_0%,transparent_60%)] pointer-events-none" />
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-[var(--yellow-glow)] border border-[var(--yellow)]/10 text-[var(--yellow)] w-max mx-auto animate-pulse">
              <BookOpen className="w-3.5 h-3.5" />
              Blog & Noticias
            </div>
            <h1 className="font-display text-4xl sm:text-6xl tracking-wider text-white uppercase leading-none">
              Novedades <span className="text-[var(--yellow)]">del Show</span>
            </h1>
            <p className="text-sm text-gray-400 max-w-xl mx-auto leading-relaxed">
              Mantente al día con las mejores entrevistas, repasos de los episodios más polémicos y primicias detrás de cámaras de tus influencers favoritos en Micasino TV Show.
            </p>
          </div>
          ...
          {posts.length === 0 ? (
            <div className="glass-card rounded-3xl p-16 text-center flex flex-col items-center justify-center border-dashed border-2 border-white/10 opacity-70">
              ...
              <p className="text-xs sm:text-sm text-gray-400 mt-2 max-w-sm mx-auto leading-relaxed">
                Aún no hay artículos cargados en el blog. Si eres administrador, abre la Consola de Creación arriba para sembrar los artículos de muestra de Capture 2.
              </p>
            </div>
          ) : (
